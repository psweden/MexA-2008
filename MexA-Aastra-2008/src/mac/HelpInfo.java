...
public class HelpInfo extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        imageGraphics.drawString("mobisma", width/2, 15, Graphics.TOP | Graphics.HCENTER);
        imageGraphics.drawString("Mobile extension Ver 1.0", width/2, 30, Graphics.TOP | Graphics.HCENTER);
