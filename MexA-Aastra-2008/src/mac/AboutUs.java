...
public AboutUs(){
    ...
    public void paint(Graphics g) {
        ...
        imageGraphics.drawString("mobisma", width/2, 20, Graphics.TOP | Graphics.HCENTER);
        imageGraphics.drawString("Mobile extension Ver 1.0", width/2, 35, Graphics.TOP | Graphics.HCENTER);
